...
DROP TABLE IF EXISTS `Admin_ActiveDelReqs`;
...
CREATE TABLE `Admin_ActiveDelReqs` (
  ...
  KEY `Req_ID` (`Req_ID`),
  CONSTRAINT `Admin_ActiveDelReqs_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_ActiveDelReqs_ibfk_2` FOREIGN KEY (`Req_ID`) REFERENCES `Delivery_Request` (`Order_ID`)
...
CREATE TABLE `Admin_Customers` (
  ...
  CONSTRAINT `Admin_Customers_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_Customers_ibfk_2` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Admin_DeliveryPersons`;

CREATE TABLE `Admin_DeliveryPersons` (
  `Admin_Username` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `DelPerson_ID` int(11) NOT NULL,
  KEY `Admin_Username` (`Admin_Username`),
  KEY `DelPerson_ID` (`DelPerson_ID`),
  CONSTRAINT `Admin_DeliveryPersons_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_DeliveryPersons_ibfk_2` FOREIGN KEY (`DelPerson_ID`) REFERENCES `Delivery_Person` (`DelPerson_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Admin_Manufacturers`;
...
CREATE TABLE `Admin_Manufacturers` (
  ...
  CONSTRAINT `Admin_Manufacturers_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_Manufacturers_ibfk_2` FOREIGN KEY (`Seller_ID`) REFERENCES `Manufacturer` (`Seller_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Admin_PendingDelReqs`;
...
CREATE TABLE `Admin_PendingDelReqs` (
  ...
  KEY `Admin_Username` (`Admin_Username`),
  KEY `Req_ID` (`Req_ID`),
  CONSTRAINT `Admin_PendingDelReqs_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_PendingDelReqs_ibfk_2` FOREIGN KEY (`Req_ID`) REFERENCES `Delivery_Request` (`Order_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Admin_Product_Categories`;
...
CREATE TABLE `Admin_Product_Categories` (
  ...
  CONSTRAINT `Admin_Product_Categories_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_Product_Categories_ibfk_2` FOREIGN KEY (`Category_ID`) REFERENCES `Product_Category` (`Category_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Admin_Products` (
  ...
  CONSTRAINT `Admin_Products_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`),
  CONSTRAINT `Admin_Products_ibfk_2` FOREIGN KEY (`Product_ID`) REFERENCES `Product` (`Product_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Cart_Product` (
  ...
  KEY `Customer_ID` (`Customer_ID`),
  KEY `Product_ID` (`Product_ID`),
  CONSTRAINT `Cart_Product_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`User_ID`),
...
CREATE TABLE `Customer` (
  ...
  `No_of_Cart_Products` int(11) NOT NULL,
  `Cart_Status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Admin_Username` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Customer_ID`),
  KEY `User_ID` (`User_ID`),
  KEY `Admin_Username` (`Admin_Username`),
  CONSTRAINT `Customer_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `Person` (`User_ID`),
  CONSTRAINT `Customer_ibfk_2` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`)
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (5, 5, 5, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (6, 6, 6, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (9, 9, 0, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (10, 10, 3, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (11, 11, 1, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (12, 12, 4, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (13, 13, 5, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (14, 14, 7, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (15, 15, 4, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (16, 16, 0, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (17, 17, 9, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (20, 20, 0, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (21, 21, 9, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (22, 22, 9, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (23, 23, 2, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (24, 24, 2, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (25, 25, 2, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (26, 26, 0, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (27, 27, 7, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (35, 35, 6, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (36, 36, 2, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (37, 37, 2, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (38, 38, 5, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (39, 39, 0, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (40, 40, 4, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (41, 41, 9, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (42, 42, 7, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (43, 43, 0, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (44, 44, 3, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (49, 49, 6, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (50, 50, 7, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (53, 53, 1, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (59, 59, 6, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (60, 60, 9, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (63, 63, 2, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (64, 64, 8, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (65, 65, 2, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (66, 66, 5, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (67, 67, 8, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (74, 74, 9, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (75, 75, 8, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (76, 76, 1, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (77, 77, 2, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (78, 78, 5, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (79, 79, 7, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (80, 80, 9, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (81, 81, 1, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (82, 82, 7, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (88, 88, 3, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (89, 89, 6, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (90, 90, 3, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (91, 91, 6, '1', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (92, 92, 6, '', 'destini.beier');
...
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (98, 98, 7, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (99, 99, 5, '', 'destini.beier');
INSERT INTO `Customer` (`Customer_ID`, `User_ID`, `No_of_Cart_Products`, `Cart_Status`, `Admin_Username`) VALUES (100, 100, 1, '', 'destini.beier');
...
CREATE TABLE `Customer_Delivery_Address` (
  ...
  KEY `ind1` (`Customer_ID`),
  CONSTRAINT `Customer_Delivery_Address_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Customer_Past_Orderr`;
...
CREATE TABLE `Customer_Past_Orderr` (
  ...
  CONSTRAINT `Customer_Past_Orderr_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`),
  CONSTRAINT `Customer_Past_Orderr_ibfk_2` FOREIGN KEY (`Order_ID`) REFERENCES `Orderr` (`Order_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (1, 1, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (2, 2, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (3, 3, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (4, 4, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (5, 5, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (6, 6, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (7, 7, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (8, 8, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (9, 9, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (10, 11, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (11, 12, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (12, 13, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (13, 14, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (14, 15, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (15, 16, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (16, 17, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (17, 19, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (18, 20, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (19, 21, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (20, 22, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (21, 23, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (22, 24, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (23, 25, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (24, 26, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (25, 27, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (26, 28, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (27, 29, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (28, 30, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (29, 31, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (30, 32, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (31, 33, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (32, 34, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (33, 35, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (34, 36, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (35, 37, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (36, 39, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (37, 40, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (38, 41, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (39, 42, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (40, 43, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (41, 44, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (42, 45, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (43, 46, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (44, 47, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (45, 48, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (46, 49, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (47, 50, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (48, 51, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (49, 52, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (50, 53, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (51, 54, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (52, 55, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (53, 56, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (54, 57, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (55, 58, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (56, 59, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (57, 60, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (58, 61, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (59, 62, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (60, 63, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (61, 64, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (62, 65, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (63, 66, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (64, 67, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (65, 68, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (66, 69, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (67, 70, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (68, 71, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (69, 72, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (70, 73, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (71, 74, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (72, 75, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (73, 76, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (74, 77, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (75, 78, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (76, 80, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (77, 81, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (78, 82, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (79, 84, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (80, 85, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (81, 87, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (82, 88, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (83, 89, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (84, 90, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (85, 91, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (86, 92, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (87, 93, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (88, 94, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (89, 95, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (90, 96, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (91, 97, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (92, 98, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (93, 99, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (94, 100, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (95, 101, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (96, 103, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (97, 104, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (98, 105, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (99, 106, '1');
INSERT INTO `Customer_Past_Orderr` (`Customer_ID`, `Order_ID`, `Cart_Status`) VALUES (100, 107, '1');
...
DROP TABLE IF EXISTS `Customer_Past_Searches`;

CREATE TABLE `Customer_Past_Searches` (
  `Customer_ID` int(11) NOT NULL,
  `Search_String` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  KEY `Customer_ID` (`Customer_ID`),
  CONSTRAINT `Customer_Past_Searches_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (2, 'Alice said to herself, and shouted out, \'You\'d better not do that again!\' which produced another dead silence. Alice noticed with some difficulty, as it can\'t possibly make me grow larger, I can.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (3, 'Just then her head struck against the door, and the bright flower-beds and the cool fountains. CHAPTER VIII. The Queen\'s argument was, that her shoulders were nowhere to be rude, so she went down to.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (4, 'CAN all that stuff,\' the Mock Turtle\'s heavy sobs. Lastly, she pictured to herself how this same little sister of hers would, in the last few minutes, and she sat on, with closed eyes, and half.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (10, 'The Cat\'s head began fading away the time. Alice had got so close to them, and all dripping wet, cross, and uncomfortable. The first witness was the Hatter. \'It isn\'t mine,\' said the King had said.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (12, 'Duchess\'s voice died away, even in the wood, \'is to grow up again! Let me see: I\'ll give them a new idea to Alice, and she tried her best to climb up one of the e--e--evening, Beautiful, beautiful.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (15, 'He unfolded the paper as he fumbled over the jury-box with the strange creatures of her own courage. \'It\'s no use in the pool was getting so thin--and the twinkling of the e--e--evening, Beautiful,.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (16, 'Hatter. \'I deny it!\' said the Hatter; \'so I should have liked teaching it tricks very much, if--if I\'d only been the whiting,\' said the Dormouse: \'not in that poky little house, and have next to.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (17, 'Caterpillar. Alice folded her hands, and began:-- \'You are old, Father William,\' the young man said, \'And your hair has become very white; And yet I wish I hadn\'t gone down that rabbit-hole--and.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (18, 'Hatter: \'as the things between whiles.\' \'Then you should say what you had been all the time he was obliged to write this down on their backs was the Cat said, waving its tail when it\'s angry, and.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (19, 'Alice, who felt very lonely and low-spirited. In a minute or two. \'They couldn\'t have done that?\' she thought. \'But everything\'s curious today. I think you\'d better finish the story for yourself.\'.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (21, 'Puss,\' she began, in a sort of lullaby to it as well say,\' added the Gryphon, half to itself, half to itself, \'Oh dear! Oh dear! I\'d nearly forgotten that I\'ve got to go down--Here, Bill! the master.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (22, 'Alice did not dare to laugh; and, as a lark, And will talk in contemptuous tones of her age knew the name of nearly everything there. \'That\'s the first position in dancing.\' Alice said; \'there\'s a.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (23, 'So she set to work nibbling at the Caterpillar\'s making such VERY short remarks, and she looked at Alice, and she went back for a few minutes, and she thought it must be the use of repeating all.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (24, 'And have grown most uncommonly fat; Yet you turned a corner, \'Oh my ears and whiskers, how late it\'s getting!\' She was moving them about as much as she spoke--fancy CURTSEYING as you\'re falling.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (25, 'I don\'t believe it,\' said the Mock Turtle sang this, very slowly and sadly:-- \'\"Will you walk a little bit, and said \'No, never\') \'--so you can have no answers.\' \'If you didn\'t sign it,\' said the.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (26, 'Don\'t let me hear the Rabbit angrily. \'Here! Come and help me out of sight, they were getting extremely small for a moment like a star-fish,\' thought Alice. \'I\'ve so often read in the distance..');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (27, 'Alice, a little while, however, she went on, looking anxiously round to see if there are, nobody attends to them--and you\'ve no idea what Latitude or Longitude either, but thought they were nice.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (28, 'I declare it\'s too bad, that it was her dream:-- First, she tried to speak, and no room at all like the name: however, it only grinned when it grunted again, and all her knowledge of history, Alice.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (30, 'Hatter said, turning to Alice. \'Nothing,\' said Alice. \'Then it doesn\'t matter a bit,\' said the Lory. Alice replied in an impatient tone: \'explanations take such a nice soft thing to eat her up in a.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (31, 'Caterpillar. \'Well, I can\'t get out again. Suddenly she came upon a Gryphon, lying fast asleep in the pool a little queer, won\'t you?\' \'Not a bit,\' she thought it would,\' said the King. The next.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (32, 'CHAPTER X. The Lobster Quadrille is!\' \'No, indeed,\' said Alice. \'I\'m a--I\'m a--\' \'Well! WHAT are you?\' And then a voice of the court. \'What do you mean \"purpose\"?\' said Alice. \'I\'ve so often read in.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (33, 'This is the use of repeating all that green stuff be?\' said Alice. \'Anything you like,\' said the King, \'and don\'t be nervous, or I\'ll have you got in your pocket?\' he went on planning to herself.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (34, 'Half-past one, time for dinner!\' (\'I only wish people knew that: then they wouldn\'t be in before the trial\'s over!\' thought Alice. \'Now we shall have to fly; and the little dears came jumping.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (35, 'Lobster Quadrille The Mock Turtle\'s Story \'You can\'t think how glad I am in the common way. So she was nine feet high. \'I wish the creatures wouldn\'t be so stingy about it, even if my head would go.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (40, 'SOME change in my kitchen AT ALL. Soup does very well as she heard the Queen merely remarking that a moment\'s pause. The only things in the night? Let me see: that would be QUITE as much as she went.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (44, 'King and Queen of Hearts, who only bowed and smiled in reply. \'Idiot!\' said the Duchess, who seemed to have lessons to learn! Oh, I shouldn\'t want YOURS: I don\'t think,\' Alice went on, \'I must be.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (45, 'I\'ve tried hedges,\' the Pigeon went on, looking anxiously about her. \'Oh, do let me hear the words:-- \'I speak severely to my right size: the next verse,\' the Gryphon repeated impatiently: \'it.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (46, 'Alice, who always took a minute or two to think that will be When they take us up and bawled out, \"He\'s murdering the time! Off with his knuckles. It was so much frightened that she hardly knew what.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (47, 'Gryphon remarked: \'because they lessen from day to day.\' This was not otherwise than what you like,\' said the King. \'Nothing whatever,\' said Alice. \'Then it wasn\'t very civil of you to death.\"\' \'You.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (48, 'Alice laughed so much at this, that she had never been in a confused way, \'Prizes! Prizes!\' Alice had never before seen a cat without a grin,\' thought Alice; \'only, as it\'s asleep, I suppose you\'ll.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (49, 'White Rabbit read out, at the proposal. \'Then the Dormouse began in a moment: she looked down at her hands, and began:-- \'You are not attending!\' said the King, and he says it\'s so useful, it\'s.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (50, 'And she squeezed herself up and down looking for the garden!\' and she felt certain it must be what he did it,) he did with the words don\'t FIT you,\' said the Queen, \'and take this child away with.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (51, 'Prizes!\' Alice had been anything near the centre of the jurors were all locked; and when she was dozing off, and she went on, \'What\'s your name, child?\' \'My name is Alice, so please your Majesty,\'.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (52, 'Mock Turtle, \'but if they do, why then they\'re a kind of rule, \'and vinegar that makes the matter on, What would become of me? They\'re dreadfully fond of pretending to be full of smoke from one end.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (56, 'I should say \"With what porpoise?\"\' \'Don\'t you mean that you think you\'re changed, do you?\' \'I\'m afraid I don\'t keep the same as they used to queer things happening. While she was quite tired and.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (57, 'So she tucked her arm affectionately into Alice\'s, and they repeated their arguments to her, though, as they all cheered. Alice thought to herself. (Alice had been looking at it uneasily, shaking it.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (64, 'Alice was beginning very angrily, but the Hatter and the baby at her hands, wondering if anything would EVER happen in a rather offended tone, \'so I can\'t put it right; \'not that it was impossible.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (65, 'Mock Turtle went on again: \'Twenty-four hours, I THINK; or is it twelve? I--\' \'Oh, don\'t bother ME,\' said Alice in a trembling voice, \'Let us get to the Caterpillar, and the sound of a sea of green.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (66, 'Lizard\'s slate-pencil, and the other guinea-pig cheered, and was coming to, but it all seemed quite natural); but when the Rabbit hastily interrupted. \'There\'s a great thistle, to keep herself from.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (67, 'Alice. \'I\'ve read that in about half no time! Take your choice!\' The Duchess took her choice, and was beating her violently with its arms folded, quietly smoking a long hookah, and taking not the.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (69, 'VERY nearly at the stick, and held out its arms folded, frowning like a snout than a rat-hole: she knelt down and looked at the Mouse\'s tail; \'but why do you know what it was: she was shrinking.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (70, 'Footman remarked, \'till tomorrow--\' At this moment Alice felt a little startled by seeing the Cheshire Cat, she was walking hand in hand with Dinah, and saying to herself \'That\'s quite enough--I.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (71, 'Rabbit in a court of justice before, but she thought it would,\' said the Pigeon; \'but if they do, why then they\'re a kind of sob, \'I\'ve tried the little passage: and THEN--she found herself at last.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (72, 'Alice! when she found she could not think of any good reason, and as Alice could think of any use, now,\' thought Alice, \'they\'re sure to happen,\' she said aloud. \'I shall sit here,\' he said, turning.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (73, 'Seaography: then Drawling--the Drawling-master was an old crab, HE was.\' \'I never heard of uglifying!\' it exclaimed. \'You know what they\'re about!\' \'Read them,\' said the Queen, stamping on the.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (74, 'Alice rather unwillingly took the hookah into its face to see what the flame of a candle is blown out, for she had not attended to this mouse? Everything is so out-of-the-way down here, and I\'m I,.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (76, 'Alice; \'it\'s laid for a long breath, and till the puppy\'s bark sounded quite faint in the sea, though you mayn\'t believe it--\' \'I never saw one, or heard of uglifying!\' it exclaimed. \'You know what.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (80, 'Hatter instead!\' CHAPTER VII. A Mad Tea-Party There was a child,\' said the King, with an important air, \'are you all ready? This is the capital of Paris, and Paris is the same words as before, \'It\'s.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (81, 'Alice with one eye, How the Owl and the other side. The further off from England the nearer is to do it! Oh dear! I wish you could draw treacle out of the miserable Mock Turtle. \'She can\'t explain.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (82, 'Alice as he said in a large mustard-mine near here. And the moral of that is--\"The more there is of finding morals in things!\' Alice thought she might as well as she could. \'The game\'s going on.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (83, 'Alice, looking down at them, and it\'ll sit up and leave the room, when her eye fell on a crimson velvet cushion; and, last of all her life. Indeed, she had read about them in books, and she sat down.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (84, 'Pigeon; \'but I know I have ordered\'; and she hurried out of the month, and doesn\'t tell what o\'clock it is!\' \'Why should it?\' muttered the Hatter. \'I told you that.\' \'If I\'d been the whiting,\' said.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (85, 'The three soldiers wandered about for some time without hearing anything more: at last came a little shaking among the trees, a little timidly: \'but it\'s no use now,\' thought poor Alice, \'it would.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (86, 'YET,\' she said to herself \'It\'s the Cheshire Cat: now I shall ever see such a nice little dog near our house I should think!\' (Dinah was the Cat said, waving its tail about in all directions, \'just.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (89, 'I\'m sure I can\'t see you?\' She was walking hand in hand with Dinah, and saying \"Come up again, dear!\" I shall only look up in great disgust, and walked two and two, as the White Rabbit cried out,.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (91, 'Mock Turtle, capering wildly about. \'Change lobsters again!\' yelled the Gryphon replied very readily: \'but that\'s because it stays the same tone, exactly as if his heart would break. She pitied him.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (92, 'Caterpillar took the watch and looked at her as she went down on their faces, and the Gryphon went on, \'What\'s your name, child?\' \'My name is Alice, so please your Majesty,\' the Hatter with a large.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (93, 'Mock Turtle. \'She can\'t explain it,\' said Alice a good deal worse off than before, as the Rabbit, and had come back and see how the Dodo suddenly called out \'The race is over!\' and they lived at the.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (95, 'And yesterday things went on planning to herself \'That\'s quite enough--I hope I shan\'t go, at any rate, the Dormouse said--\' the Hatter was out of its right paw round, \'lives a Hatter: and in THAT.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (96, 'Caterpillar took the thimble, looking as solemn as she could not possibly reach it: she could not remember the simple rules their friends had taught them: such as, that a moment\'s pause. The only.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (99, 'WAS no one to listen to me! I\'LL soon make you dry enough!\' They all sat down again very sadly and quietly, and looked at Two. Two began in a day is very confusing.\' \'It isn\'t,\' said the youth, \'as.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (1, 'Gryphon. \'--you advance twice--\' \'Each with a sigh: \'it\'s always tea-time, and we\'ve no time she\'d have everybody executed, all round. \'But she must have been changed for any of them. However, on.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (4, 'I gave her one, they gave him two, You gave us three or more; They all made a memorandum of the legs of the Queen\'s hedgehog just now, only it ran away when it saw Alice. It looked good-natured, she.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (7, 'I wonder if I\'ve been changed for Mabel! I\'ll try and say \"Who am I to get in?\' \'There might be hungry, in which you usually see Shakespeare, in the pool of tears which she found she could see, as.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (8, 'I learn music.\' \'Ah! that accounts for it,\' said Alice, quite forgetting in the flurry of the words \'DRINK ME,\' but nevertheless she uncorked it and put back into the teapot. \'At any rate I\'ll never.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (9, 'I don\'t think,\' Alice went on eagerly: \'There is such a pleasant temper, and thought to herself, \'if one only knew how to get hold of anything, but she had tired herself out with his head!\' she.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (10, 'The Caterpillar was the Hatter. \'He won\'t stand beating. Now, if you want to get her head to hide a smile: some of the other players, and shouting \'Off with his nose Trims his belt and his buttons,.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (11, 'I don\'t believe you do lessons?\' said Alice, feeling very glad that it was perfectly round, she came upon a time she saw in another moment, when she found herself in the distance. \'Come on!\' cried.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (12, 'The Mouse looked at it gloomily: then he dipped it into one of the song. \'What trial is it?\' The Gryphon sat up and said, without even looking round. \'I\'ll fetch the executioner ran wildly up and.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (13, 'I hadn\'t to bring but one; Bill\'s got to the whiting,\' said Alice, as she had forgotten the little creature down, and felt quite relieved to see you again, you dear old thing!\' said the King. \'I.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (15, 'Mouse\'s tail; \'but why do you want to go! Let me see: four times seven is--oh dear! I shall never get to the baby, and not to lie down upon her: she gave one sharp kick, and waited to see some.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (16, 'I suppose?\' said Alice. \'And where HAVE my shoulders got to? And oh, my poor little thing was snorting like a frog; and both creatures hid their faces in their mouths--and they\'re all over crumbs.\'.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (18, 'Like a tea-tray in the distance, screaming with passion. She had quite forgotten the words.\' So they got settled down again in a sorrowful tone; \'at least there\'s no use their putting their heads.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (19, 'Alice did not sneeze, were the cook, to see if she did not like to have lessons to learn! No, I\'ve made up my mind about it; and the words \'DRINK ME\' beautifully printed on it were white, but there.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (20, 'Knave of Hearts, he stole those tarts, And took them quite away!\' \'Consider your verdict,\' the King triumphantly, pointing to Alice again. \'No, I give it up,\' Alice replied: \'what\'s the answer?\' \'I.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (21, 'Latitude or Longitude I\'ve got back to the dance. Would not, could not, would not, could not, could not, could not, could not, would not, could not, would not join the dance? Will you, won\'t you,.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (22, 'Alice. \'Why, there they lay sprawling about, reminding her very much what would happen next. \'It\'s--it\'s a very small cake, on which the March Hare interrupted in a deep voice, \'are done with a kind.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (23, 'Alice replied very readily: \'but that\'s because it stays the same size: to be rude, so she set to partners--\' \'--change lobsters, and retire in same order,\' continued the Pigeon, raising its voice.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (24, 'And beat him when he sneezes; For he can thoroughly enjoy The pepper when he sneezes; For he can EVEN finish, if he wasn\'t one?\' Alice asked. The Hatter was the Duchess\'s knee, while plates and.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (25, 'That\'s all.\' \'Thank you,\' said the Queen, but she could not think of anything else. CHAPTER V. Advice from a Caterpillar The Caterpillar was the Hatter. \'Nor I,\' said the Dodo solemnly, rising to.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (29, 'EVEN finish, if he wasn\'t going to leave it behind?\' She said this last word with such sudden violence that Alice quite jumped; but she could not be denied, so she tried to curtsey as she swam.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (30, 'I\'ll kick you down stairs!\' \'That is not said right,\' said the young Crab, a little scream of laughter. \'Oh, hush!\' the Rabbit began. Alice gave a little girl she\'ll think me for a moment like a.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (33, 'Knave, \'I didn\'t know that you\'re mad?\' \'To begin with,\' said the Queen, \'Really, my dear, and that in some alarm. This time there were no tears. \'If you\'re going to remark myself.\' \'Have you.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (34, 'Footman remarked, \'till tomorrow--\' At this moment Five, who had been found and handed back to the Gryphon. \'How the creatures argue. It\'s enough to get rather sleepy, and went down to the Knave..');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (36, 'After a while she was small enough to try the first position in dancing.\' Alice said; but was dreadfully puzzled by the soldiers, who of course you don\'t!\' the Hatter said, turning to Alice with one.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (39, 'Why, there\'s hardly room to open it; but, as the March Hare, \'that \"I like what I used to come yet, please your Majesty?\' he asked. \'Begin at the other, looking uneasily at the Hatter, it woke up.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (43, 'I will tell you more than that, if you were down here till I\'m somebody else\"--but, oh dear!\' cried Alice, quite forgetting that she began nursing her child again, singing a sort of thing that would.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (46, 'Alice noticed, had powdered hair that curled all over crumbs.\' \'You\'re wrong about the whiting!\' \'Oh, as to go with Edgar Atheling to meet William and offer him the crown. William\'s conduct at first.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (47, 'King; and the happy summer days. THE.');
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (48, 'The first question of course was, how to speak with. Alice waited till she had accidentally upset the milk-jug into his plate. Alice did not seem to be\"--or if you\'d rather not.\' \'We indeed!\' cried.');
...
INSERT INTO `Customer_Past_Searches` (`Customer_ID`, `Search_String`) VALUES (50, 'She had already heard her sentence three of the shepherd boy--and the sneeze of the teacups as the whole window!\' \'Sure, it does, yer honour: but it\'s an arm for all that.\' \'With extras?\' asked the.');
...
DROP TABLE IF EXISTS `Customer_Pending_Orderr`;
...
CREATE TABLE `Customer_Pending_Orderr` (
  ...
  KEY `Customer_ID` (`Customer_ID`),
  KEY `Order_ID` (`Order_ID`),
  CONSTRAINT `Customer_Pending_Orderr_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`User_ID`),
  CONSTRAINT `Customer_Pending_Orderr_ibfk_2` FOREIGN KEY (`Order_ID`) REFERENCES `Orderr` (`Order_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Delivery_Person` (
  `DelPerson_ID` int(11) NOT NULL,
  `User_ID` int(11) NOT NULL,
  `Active_Delivery_Request` int(11) NOT NULL,
  `Delivery_Rating` int(11) NOT NULL,
  `Admin_Username` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`DelPerson_ID`),
  KEY `User_ID` (`User_ID`),
  KEY `Active_Delivery_Request` (`Active_Delivery_Request`),
  KEY `Admin_Username` (`Admin_Username`),
  CONSTRAINT `Delivery_Person_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `Person` (`User_ID`),
  CONSTRAINT `Delivery_Person_ibfk_2` FOREIGN KEY (`Active_Delivery_Request`) REFERENCES `Orderr` (`Order_ID`),
  CONSTRAINT `Delivery_Person_ibfk_3` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Delivery_Person_Completed_Delivery`;
...
CREATE TABLE `Delivery_Person_Completed_Delivery` (
  ...
  KEY `DelPerson_ID` (`DelPerson_ID`),
  KEY `Order_ID` (`Order_ID`),
  CONSTRAINT `Delivery_Person_Completed_Delivery_ibfk_1` FOREIGN KEY (`DelPerson_ID`) REFERENCES `Delivery_Person` (`DelPerson_ID`),
  CONSTRAINT `Delivery_Person_Completed_Delivery_ibfk_2` FOREIGN KEY (`Order_ID`) REFERENCES `Orderr` (`Order_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Delivery_Request` (
  ...
  CONSTRAINT `Delivery_Request_ibfk_1` FOREIGN KEY (`Order_ID`) REFERENCES `Orderr` (`Order_ID`),
  CONSTRAINT `Delivery_Request_ibfk_2` FOREIGN KEY (`Delivery_ID`) REFERENCES `Customer` (`Customer_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (1, 1, '1989-11-24 19:16:07', '101801', 1);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (2, 0, '2021-07-15 09:30:34', '154971', 2);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (3, 1, '2020-08-15 08:52:00', '959677', 3);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (4, 1, '2005-07-06 15:54:24', '866868', 4);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (5, 1, '1984-10-29 17:02:53', '255854', 5);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (6, 0, '2004-08-12 01:00:37', '63160', 6);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (7, 1, '1979-02-17 14:40:40', '525892', 7);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (8, 0, '1977-09-21 18:56:24', '56901', 8);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (9, 1, '1990-04-14 01:49:33', '213807', 9);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (11, 1, '2013-03-08 13:12:28', '431152', 10);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (12, 0, '1988-10-18 19:03:15', '262693', 11);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (13, 0, '1986-07-15 03:54:42', '397791', 12);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (14, 1, '2004-11-05 22:39:37', '160820', 13);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (15, 1, '2011-04-29 06:21:30', '500513', 14);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (16, 1, '2011-02-03 04:12:26', '624584', 15);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (17, 0, '1996-02-29 20:57:34', '597980', 16);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (19, 0, '1993-09-21 04:39:25', '85478', 17);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (20, 1, '2000-04-24 10:27:51', '157780', 18);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (21, 0, '2015-06-28 00:32:38', '991779', 19);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (22, 1, '2005-08-24 05:49:33', '713849', 20);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (23, 0, '1978-12-19 19:50:56', '727153', 21);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (24, 0, '2001-01-27 02:33:41', '759068', 22);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (25, 0, '1975-02-28 07:03:02', '35471', 23);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (26, 0, '1996-08-06 11:07:08', '550086', 24);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (27, 0, '1989-06-24 08:17:22', '991183', 25);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (28, 1, '1996-01-29 13:33:27', '917826', 26);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (29, 0, '1979-11-25 23:35:30', '187875', 27);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (30, 1, '1978-10-28 05:49:28', '172502', 28);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (31, 1, '2010-01-06 07:02:44', '33197', 29);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (32, 0, '2003-12-16 19:18:18', '67622', 30);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (33, 0, '2003-04-12 11:26:29', '212039', 31);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (34, 0, '1994-04-11 19:15:29', '315209', 32);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (35, 1, '1999-07-04 07:53:32', '732614', 33);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (36, 0, '1978-12-19 16:00:40', '966812', 34);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (37, 1, '2011-03-29 21:08:28', '68705', 35);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (39, 1, '1989-03-31 17:06:27', '441243', 36);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (40, 1, '1984-09-07 14:53:42', '197785', 37);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (41, 0, '1990-06-14 11:46:58', '881950', 38);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (42, 1, '1975-03-05 21:08:25', '787541', 39);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (43, 0, '1975-07-31 19:57:40', '700433', 40);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (44, 1, '2008-10-09 14:06:23', '267555', 41);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (45, 1, '1989-11-10 15:52:33', '593292', 42);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (46, 0, '1994-04-15 06:50:51', '209494', 43);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (47, 0, '2011-07-19 11:08:37', '36177', 44);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (48, 1, '1983-12-27 18:14:21', '177665', 45);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (49, 0, '2010-04-21 05:23:52', '806236', 46);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (50, 1, '2015-07-25 10:02:58', '220183', 47);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (51, 1, '2021-06-22 21:39:06', '596432', 48);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (52, 0, '1989-12-22 13:48:00', '374814', 49);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (53, 1, '1971-08-13 20:11:28', '396305', 50);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (54, 0, '2005-11-27 13:44:12', '450054', 51);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (55, 1, '1980-04-27 16:38:01', '616594', 52);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (56, 1, '1983-03-28 15:56:30', '300687', 53);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (57, 0, '2016-04-06 13:07:43', '994293', 54);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (58, 0, '2012-06-27 19:09:42', '263049', 55);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (59, 1, '1971-04-07 14:42:35', '972097', 56);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (60, 1, '1981-05-02 13:21:48', '166429', 57);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (61, 1, '1999-02-05 08:07:24', '665752', 58);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (62, 1, '1979-01-27 09:25:35', '490951', 59);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (63, 1, '2012-11-11 23:25:50', '962636', 60);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (64, 1, '1996-02-16 04:10:13', '395169', 61);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (65, 0, '2017-12-23 13:11:12', '440620', 62);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (66, 1, '1991-04-14 21:16:06', '864106', 63);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (67, 1, '2021-12-06 11:56:54', '945383', 64);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (68, 1, '2016-10-14 22:52:56', '676528', 65);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (69, 1, '1974-12-12 09:10:09', '684492', 66);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (70, 1, '1978-06-17 06:31:37', '194504', 67);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (71, 0, '1983-04-19 22:04:36', '184124', 68);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (72, 1, '1970-06-07 00:23:49', '640629', 69);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (73, 1, '1974-07-30 13:39:54', '79095', 70);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (74, 1, '2008-07-26 16:14:37', '953542', 71);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (75, 1, '1982-02-02 22:47:39', '352206', 72);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (76, 1, '2000-06-18 12:11:55', '479896', 73);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (77, 1, '2002-12-05 12:29:16', '300493', 74);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (78, 0, '2002-11-04 04:42:24', '857753', 75);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (80, 1, '1997-02-18 10:29:52', '383493', 76);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (81, 0, '2021-06-18 16:01:46', '681465', 77);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (82, 0, '2018-08-20 11:37:14', '817237', 78);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (84, 1, '2011-06-12 20:58:56', '809403', 79);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (85, 0, '1979-06-28 09:40:22', '327121', 80);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (87, 1, '2018-04-24 17:09:22', '462552', 81);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (88, 1, '2010-08-15 02:11:11', '156593', 82);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (89, 0, '1983-05-27 21:32:05', '601590', 83);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (90, 1, '1982-12-23 22:56:17', '223245', 84);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (91, 1, '2009-11-03 22:40:03', '973199', 85);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (92, 1, '2006-02-20 21:22:46', '986328', 86);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (93, 1, '2021-07-13 11:30:14', '578664', 87);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (94, 1, '1981-05-04 18:13:52', '535990', 88);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (95, 0, '2015-03-16 13:06:41', '901571', 89);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (96, 1, '1995-07-19 01:20:44', '177333', 90);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (97, 1, '1984-12-31 05:16:20', '979290', 91);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (98, 1, '2011-09-24 04:32:36', '626946', 92);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (99, 0, '1979-01-30 13:32:48', '636112', 93);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (100, 0, '1982-06-07 02:12:58', '553543', 94);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (101, 1, '1997-10-12 15:48:10', '167562', 95);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (103, 1, '2009-05-18 21:15:50', '348147', 96);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (104, 0, '1971-06-10 08:23:39', '124329', 97);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (105, 1, '2003-07-09 21:46:55', '773788', 98);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (106, 0, '2005-03-21 17:39:44', '329367', 99);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (107, 0, '2020-12-11 09:53:40', '517905', 100);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (108, 0, '2001-03-05 08:53:42', '637490', 1);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (109, 0, '1976-07-05 04:06:20', '640812', 2);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (110, 0, '2003-02-12 11:05:50', '707519', 3);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (111, 1, '1991-09-18 19:12:41', '343685', 4);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (112, 0, '2004-12-15 02:59:12', '896635', 5);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (113, 1, '1979-07-10 04:32:59', '878477', 6);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (114, 0, '1986-07-04 03:44:30', '716237', 7);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (115, 0, '1999-08-03 12:31:31', '873109', 8);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (116, 0, '1996-03-06 10:36:32', '889848', 9);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (117, 1, '1971-02-12 03:04:18', '971256', 10);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (118, 0, '1998-04-02 16:26:45', '9158', 11);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (119, 1, '1985-08-11 08:47:13', '267348', 12);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (120, 1, '2009-03-01 09:58:56', '940434', 13);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (121, 1, '2006-04-01 20:16:37', '350067', 14);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (122, 0, '1972-03-18 13:17:18', '516941', 15);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (123, 1, '1996-11-18 12:51:20', '371360', 16);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (124, 1, '2016-03-20 10:43:52', '405680', 17);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (125, 1, '2008-10-07 05:02:42', '210703', 18);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (126, 1, '1984-10-21 14:45:00', '379299', 19);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (127, 1, '1998-07-07 00:24:46', '390859', 20);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (128, 1, '2012-11-23 03:59:57', '961320', 21);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (129, 1, '1970-01-18 19:56:48', '659513', 22);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (130, 0, '2019-07-29 12:15:11', '379355', 23);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (131, 0, '2002-12-13 07:05:54', '825076', 24);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (132, 1, '1981-08-18 22:26:14', '596251', 25);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (133, 0, '1975-01-21 11:44:47', '954006', 26);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (134, 1, '2009-09-29 00:12:36', '189487', 27);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (135, 1, '2016-04-07 21:08:52', '450342', 28);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (136, 0, '1986-06-04 12:37:58', '128351', 29);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (137, 0, '2010-08-04 03:32:17', '98013', 30);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (138, 0, '1984-04-04 00:58:46', '18416', 31);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (139, 0, '1998-12-21 21:46:53', '692450', 32);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (140, 0, '1989-07-08 15:40:51', '860653', 33);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (141, 0, '1998-05-12 10:49:57', '103835', 34);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (142, 1, '2005-05-30 01:02:34', '688283', 35);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (144, 1, '2020-10-28 20:27:57', '834145', 36);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (145, 0, '1984-05-03 00:36:35', '793170', 37);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (146, 0, '2000-10-23 05:06:45', '810956', 38);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (147, 1, '2019-10-04 21:03:05', '937866', 39);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (148, 0, '1983-05-04 13:29:28', '234977', 40);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (149, 1, '2007-11-01 07:17:34', '127252', 41);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (150, 1, '2017-07-31 21:27:20', '22926', 42);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (151, 0, '2016-06-07 03:04:18', '224286', 43);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (152, 1, '1985-06-19 05:47:49', '324104', 44);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (153, 1, '1970-11-13 09:16:30', '387651', 45);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (154, 1, '1978-03-30 13:56:14', '643824', 46);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (155, 0, '1975-04-30 19:13:07', '430762', 47);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (156, 1, '2006-10-09 17:06:22', '408656', 48);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (157, 0, '1986-04-13 18:14:56', '791737', 49);
INSERT INTO `Delivery_Request` (`Order_ID`, `Delivery_Status`, `Expected_Completion_Time`, `Amount_Payable`, `Delivery_ID`) VALUES (158, 0, '2011-04-05 11:28:35', '519934', 50);
...
CREATE TABLE `Manufacturer` (
  ...
  KEY `User_ID` (`User_ID`),
  KEY `Admin_Username` (`Admin_Username`),
  CONSTRAINT `Manufacturer_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `Person` (`User_ID`),
  CONSTRAINT `Manufacturer_ibfk_2` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`)
...
DROP TABLE IF EXISTS `Manufacturer_Product_Sold`;
...
CREATE TABLE `Manufacturer_Product_Sold` (
  ...
  KEY `Seller_ID` (`Seller_ID`),
  KEY `Product_ID` (`Product_ID`),
  CONSTRAINT `Manufacturer_Product_Sold_ibfk_1` FOREIGN KEY (`Seller_ID`) REFERENCES `Manufacturer` (`Seller_ID`),
  CONSTRAINT `Manufacturer_Product_Sold_ibfk_2` FOREIGN KEY (`Product_ID`) REFERENCES `Product` (`Product_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Manufacturer_Upcoming_Product`;
...
CREATE TABLE `Manufacturer_Upcoming_Product` (
  ...
  KEY `Seller_ID` (`Seller_ID`),
  KEY `Product_ID` (`Product_ID`),
  CONSTRAINT `Manufacturer_Upcoming_Product_ibfk_1` FOREIGN KEY (`Seller_ID`) REFERENCES `Manufacturer` (`Seller_ID`),
  CONSTRAINT `Manufacturer_Upcoming_Product_ibfk_2` FOREIGN KEY (`Product_ID`) REFERENCES `Product` (`Product_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Orderr_Product`;
...
CREATE TABLE `Orderr_Product` (
  ...
  KEY `Order_ID` (`Order_ID`),
  KEY `Product_ID` (`Product_ID`),
  CONSTRAINT `Orderr_Product_ibfk_1` FOREIGN KEY (`Order_ID`) REFERENCES `Orderr` (`Order_ID`),
  CONSTRAINT `Orderr_Product_ibfk_2` FOREIGN KEY (`Product_ID`) REFERENCES `Product` (`Product_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Person` (
  ...
  `Is_Card_Saved` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Card_no` bigint(20) DEFAULT NULL,
  `Name_on_Card` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Expire_Date` date DEFAULT NULL,
  `Is_UPI_Saved` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `UPI_ID` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Admin_Username` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`User_ID`),
  KEY `Admin_Username` (`Admin_Username`),
  CONSTRAINT `Person_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`)
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (1, 'augustus53', 'e4e1ac395631b03f3b0116d0901a2e771b93fcc9', 'Vicenta', 'Braulio', 'Koelpin', 'hilario50@yahoo.com', '', '5414956879621701', 'Alexis Ullrich', '1975-09-07', '', '05087980601', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (2, 'jesse.wisoky', '84a439ebeeb53ffcb5deb11ac4ef00d5fd9493d6', 'Dagmar', 'Aileen', 'Crooks', 'skylar.mayert@gmail.com', '', '5418277396459435', 'Dr. Thalia Legros DVM', '1989-09-18', '1', '(084)363-5544', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (3, 'greenholt.candace', '0ea4d492208de623a630bddabc464aff843b593a', 'Alejandra', 'Louie', 'Nitzsche', 'umorissette@gmail.com', '', '5119548863267667', 'Marlen Prosacco', '1983-05-25', '', '893.357.2398', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (5, 'kshlerin.murl', '21cd57165ed6832aeb194bcd2d87ef3735a37a5c', 'Brain', 'Jade', 'Kunze', 'hahn.velva@parisian.com', '1', '5360754107932934', 'Ethelyn Mann', '2020-12-28', '', '(449)249-9347x81032', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (6, 'jazmyn09', 'f2e703a9a617a03e7336824039afe8a8746dc7be', 'Werner', 'Makayla', 'Glover', 'schoen.rylan@kuhnflatley.com', '1', '4024007166631406', 'Jonathon Hoeger', '2005-11-16', '', '+21(5)4562327035', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (7, 'nolan.marian', '28a10d035e9dc0355f8403042b21e93af764e5c4', 'Alvina', 'Esmeralda', 'Farrell', 'javon30@kunze.net', '1', '4929145701565818', 'Gerda Blanda', '2014-07-05', '', '09118645877', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (8, 'rory.hills', 'bed1b5904c0e50552e492b3fe4cde7fbe34d716b', 'Duane', 'Samara', 'Medhurst', 'hilma92@quitzon.org', '', '5522204843757513', 'Claire Zemlak', '2000-01-16', '', '(438)530-7208', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (15, 'beier.noemie', 'd57798f42304c4bd45121e3f6373d69341caa89a', 'Laurie', 'Maud', 'Jones', 'rweber@grimes.biz', '1', '5114687622323531', 'Casimer Kohler', '2003-05-16', '', '1-053-844-0230', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (16, 'eshields', '3b7d6b914d443d5fff693790e8e49ea2e43ad7fa', 'Saul', 'Liam', 'Gerlach', 'sammie78@smith.org', '', '4024007135703989', 'Prof. Reynold Jerde', '1971-11-17', '1', '160.099.2957x3216', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (17, 'ykutch', '3016f5274624289be1126a1bf5004262e505bfa2', 'Buddy', 'Jerald', 'Bayer', 'marlee.dooley@herzogwillms.com', '', '6011519322744392', 'Prof. Michael McCullough', '1978-05-30', '', '1-799-537-7623x8575', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (20, 'qbreitenberg', '8cfb75cb999b66258885df23ad16744e734c7609', 'Sierra', 'Priscilla', 'Ernser', 'lillie.hessel@hotmail.com', '', '5506157435788489', 'Delpha Ernser', '1989-07-18', '', '545.028.0678x441', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (21, 'bridie.gerhold', '5f7b12c8da3328035d85008aac9b810006d30d7c', 'April', 'Nichole', 'Lehner', 'federico.hessel@hotmail.com', '', '5534016365089489', 'Ervin Flatley', '1979-12-18', '1', '08376540673', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (22, 'parker.jeanne', '51e0d55de2afcea393f835239d71be38d32e5944', 'Jesus', 'Monica', 'McKenzie', 'kieran.beahan@yahoo.com', '1', '4322891037428', 'Jaren Huels', '1978-01-10', '', '583.088.9634', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (23, 'olga.kihn', '8d7964c7f6fd5384cc2f21254dedc4d199f12ec8', 'Annabell', 'Madeline', 'Schuster', 'gemard@gmail.com', '', '5170599003526949', 'Dr. Josianne Koss', '1982-11-19', '', '1-162-801-4351', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (24, 'deondre.fritsch', '7ab1a5f049c1817d7d286e8e473e0c9ea26f0d85', 'Freida', 'Lea', 'Senger', 'kyleigh.nolan@hotmail.com', '', '5175443951932685', 'Blair Stroman PhD', '2023-01-10', '1', '499.491.4080x5422', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (25, 'brian85', '52a1ec0ce802795860c3c155023d2f3a2463d065', 'Merritt', 'Ali', 'Tromp', 'lkling@hotmail.com', '', '4716910440848', 'Prof. Arden Mraz', '2010-01-19', '', '1-588-267-0150x99396', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (26, 'ubaldo18', '3c53929faa71a03bff76e6f1baaaf09bbd7a01dd', 'Marge', 'Alec', 'McKenzie', 'kylee71@hotmail.com', '', '343539963258064', 'Marcella Pfeffer', '2000-02-18', '1', '01302866309', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (27, 'wellington95', 'f94646299db11986605f2595556feea52ef74cad', 'Bertrand', 'Gaylord', 'Bogan', 'iabshire@yahoo.com', '', '4485592389008077', 'Chelsea Friesen', '1978-05-11', '', '1-594-033-2899x37885', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (28, 'oleannon', 'c110b165f66378cbf4ffc42c074a06766937cc57', 'Felicia', 'Brendon', 'Altenwerth', 'iwisozk@gmail.com', '', '6011146290785678', 'Mr. Elmore Koch Sr.', '2017-10-22', '', '+51(3)3831156859', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (38, 'wolff.jailyn', '9c349229828fe29ea196e16f13067501e2e7555c', 'Florine', 'Ignacio', 'Bednar', 'shanie.paucek@stiedemann.com', '1', '4485719147502580', 'Federico Kiehn', '2018-03-03', '', '(025)914-3261x64448', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (39, 'larkin.nicolette', '686e9fb96999b5696cc17e925f033e301e1953fd', 'Keshaun', 'Magdalen', 'O\'Hara', 'joanne19@osinski.org', '', '5222993574518769', 'Price Moore', '2013-08-10', '', '1-577-549-7422', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (40, 'ikeebler', 'c5d5b41f4ca95b2ff217ba0529a0edffe467fcaa', 'Antwan', 'Ollie', 'Gusikowski', 'myrtis88@yahoo.com', '', '346048335373380', 'Prof. Marjory Donnelly', '1979-10-20', '', '609.013.5151', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (41, 'ida12', '168f6ad4540d8964f9ba83104b5f431bb6377d1c', 'Lucius', 'Dorothea', 'Satterfield', 'ppurdy@cassin.com', '1', '4485167126063', 'Dr. Alexandre Senger DVM', '1997-01-14', '', '(515)909-5953x9637', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (49, 'zschmeler', '9e3019feb7323a8dce9186fe4db2ad4182ef4306', 'Gerald', 'Avis', 'Kunde', 'irunolfsdottir@gmail.com', '', '6011457303441093', 'Hope Simonis', '1973-11-03', '', '590.344.6240x499', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (50, 'jacobson.arno', '17baff63526c8b8a47f77cb7a65d70ad927ab584', 'Lillie', 'Adonis', 'Johnston', 'myrna.carter@barrowsmacejkovic.com', '', '4485714735947', 'Maud D\'Amore', '1976-11-30', '1', '195.457.2061', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (55, 'huel.quinton', '037b97bf12e4945adc5626dfa93f9f89e9e1b496', 'Rubye', 'Eryn', 'Ondricka', 'hgoyette@hayes.biz', '', '4391311466110358', 'Louvenia Oberbrunner III', '2006-01-27', '1', '240-709-4656', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (56, 'francis.kuphal', '8456364a5055e778f99d57a05d7550f1a193ab0f', 'Shirley', 'Teagan', 'Cummings', 'dino.aufderhar@tillman.com', '', '5480303871587795', 'Ashly Ebert III', '2014-02-24', '1', '1-878-321-4513x8258', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (58, 'xavier08', '61afc1e7b5baef3d219cecb7075294a953cd6cd0', 'Miles', 'Antone', 'Christiansen', 'qcronin@pfannerstill.org', '1', '5252315462346212', 'Kacie O\'Conner', '1988-12-16', '', '(044)763-8802x2601', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (59, 'lpadberg', '3d6e11cea34e1a8492da0202f6c5bef0a3004019', 'Mara', 'Laney', 'Buckridge', 'yoshiko62@zemlak.info', '', '4716245303812135', 'Dr. Arlo Weber IV', '1980-04-11', '1', '+20(5)4294388731', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (60, 'rebeca.zulauf', '28ec9b4619bcbf27295480887883622489fb6839', 'Mustafa', 'Russ', 'Kling', 'od\'amore@hills.com', '', '4024007131541', 'Mrs. Bernadine Upton', '1971-07-07', '', '04777570444', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (62, 'uswaniawski', '7be4d28570bb9b32c5ea5baeacbacb01ed40ab51', 'Florence', 'Lupe', 'Sipes', 'missouri08@yahoo.com', '', '343628022013970', 'Antoinette Pfeffer', '1970-09-30', '1', '1-171-789-9491x1294', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (63, 'feil.lia', '8720ebe7eed335ad5e38856559ddae69bc461443', 'Troy', 'Vilma', 'Kassulke', 'orutherford@kub.com', '', '5238208706940057', 'Nestor Hackett', '1980-03-08', '', '(174)557-4205x1212', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (65, 'rosendo.gorczany', '8631f446dbfba640337ea9ba3997b552974a286c', 'Hailey', 'Margarett', 'Stiedemann', 'lorine20@ullrich.com', '', '4532543929208403', 'Erling Zieme', '2004-10-24', '', '05863154740', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (66, 'berta64', 'fd49313a979504e2690a566baa4cee222c60b5c0', 'Athena', 'Brendon', 'Steuber', 'billie.grimes@yahoo.com', '', '4556966602984297', 'Prof. Florian Runolfsdottir', '2008-05-18', '1', '1-748-052-3910', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (67, 'kuhlman.lolita', '7081da03f4a870d3639b41719cc40b27da862eed', 'Salvador', 'Leopold', 'Walter', 'johnnie.goldner@gmail.com', '', '348476085589032', 'Miss Bridie Ernser', '1982-07-19', '1', '1-541-393-1887x8730', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (68, 'aschulist', 'fae2f8e4537019d05c086ebe235857c912bac78a', 'Aletha', 'Josie', 'Batz', 'jayson.kertzmann@bins.com', '1', '5169287642238692', 'Jon Friesen', '2019-12-14', '', '1-085-540-8080x83431', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (70, 'lehner.asa', 'e36404a5cbd60cdbfb8cbe072027de0675a34959', 'Jedediah', 'Mariela', 'Johnson', 'erdman.neva@hotmail.com', '1', '347820218085958', 'Claudine Schroeder', '1974-11-02', '', '1-628-119-3657', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (71, 'naomie19', 'd262dfbb9216fffbe7a6cc8e69c928093c0b01a1', 'Hattie', 'Rory', 'Rutherford', 'drunolfsdottir@feest.com', '', '4556806575893443', 'Rebeka Block', '1974-10-27', '1', '(223)946-3288x3125', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (72, 'roxane62', '399befc9086dbf89c3f413e0efcdbef5fdd766a1', 'Lavina', 'Leonor', 'Osinski', 'ygislason@rolfsonhilll.com', '', '5154454565282686', 'Ms. Elisa Dach Sr.', '1998-11-01', '1', '(958)273-2779x7189', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (73, 'adrienne.cormier', 'a85679042ed74efcf57df993ca7e02756d7ca3f3', 'Joanie', 'Erik', 'Hintz', 'predovic.cecile@hettinger.org', '', '5571049223732640', 'Enid Pfannerstill', '1983-09-26', '', '01895145200', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (74, 'qwintheiser', '722df6368cb3018121c7b0e26f922521ff9c57ee', 'Heloise', 'Timmy', 'Farrell', 'alyce93@parker.com', '', '4929529151688', 'Dr. Adah Mante IV', '1977-07-17', '', '305-828-0913x60825', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (75, 'harris.preston', '95a436c4caab0ba314c4d447819eb7f1d727ffae', 'Isabell', 'Bessie', 'Becker', 'asha22@yahoo.com', '1', '6011464505318809', 'Roscoe Fisher IV', '1983-02-17', '', '420-021-0517x831', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (77, 'brooklyn.barrows', '8e3df33e4ae4e13ab564198d031c907e2edc7a90', 'Edmond', 'Gerhard', 'Schuster', 'thaag@gmail.com', '', '5443286086839644', 'Brian Ziemann', '2003-01-21', '1', '09385666741', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (78, 'jalen94', 'bad4d91cecbe7781a769257542563bc2ccee0d45', 'Cheyanne', 'Bridgette', 'Bauch', 'gconsidine@hotmail.com', '', '5413641788865249', 'Macie Beier III', '1975-03-25', '1', '(263)351-0004x517', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (79, 'christophe.bailey', '2fe41718bef2e13910e8dfe120aa8dcc6a3cbcdd', 'Judd', 'Camilla', 'Lehner', 'ward.josiane@yahoo.com', '', '5431482582911462', 'Allen Steuber PhD', '1982-03-08', '', '1-736-509-1393x28565', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (80, 'tressa.koelpin', '6a6436e4ef39c71803d83aef16e8780af89da219', 'Yolanda', 'Shyann', 'Bartell', 'damaris22@yahoo.com', '1', '4916115027746332', 'Chaim O\'Conner', '1986-03-30', '', '549.346.5995', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (81, 'huel.saige', '009d04f4867736595bd0913c0040c86f1247ebbb', 'Ettie', 'Elvera', 'Kerluke', 'issac.yundt@yahoo.com', '', '4532793577035', 'Natalia Brown I', '2002-02-14', '1', '02202960528', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (82, 'wunsch.kallie', '3a14587bcd10f0f6e626efa0091e9123e98f0955', 'Brittany', 'Garrison', 'Schroeder', 'cronin.ella@gmail.com', '1', '4485564849960', 'London Rowe', '1977-10-12', '', '(432)094-0116', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (83, 'einar.hauck', 'bf853dc55e447d8a21220ea3992a3740edcfbf49', 'Concepcion', 'Josh', 'Ziemann', 'ryleigh15@gmail.com', '', '5414957910228803', 'Montana Aufderhar', '2020-05-20', '1', '604-257-4895x715', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (84, 'apadberg', 'c5664a40cb95a5f9fcea9bf4a2e8af621741d0be', 'Etha', 'Dexter', 'Krajcik', 'dhammes@gmail.com', '', '372057315786539', 'Dejon Gaylord', '1973-07-16', '1', '749.378.3262', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (85, 'kovacek.sierra', '53e36c7f50be481221bd386ef0df89501189baec', 'Estelle', 'Gunner', 'Daugherty', 'donald53@wiegand.net', '', '5100245138284112', 'Gene Heaney', '2021-04-27', '', '999.633.5157', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (86, 'samara23', '44fa74e9e69dfe47a2c11db765717bc2664cce3c', 'Gina', 'Gus', 'McGlynn', 'elbert.wolff@gleason.com', '', '4929581056862', 'Crystal Nikolaus I', '2015-06-21', '', '1-368-456-7624x4607', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (88, 'xwelch', 'a6af8a0df94d9dfa92453ea129b5e3fbc33fd9f8', 'Luella', 'Trace', 'Schneider', 'milo.robel@emmerich.com', '1', '5553255641047012', 'Oceane Larkin', '2017-05-03', '', '(315)658-8334x685', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (89, 'mhamill', '9cda757aa649a038e12f48837c323cdc74e090ad', 'Arnold', 'Heather', 'Koch', 'dorcas99@satterfieldkihn.com', '1', '6011097931315167', 'Felicita Swift', '1976-11-22', '', '165.164.3437x43035', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (90, 'hjohnson', '8e64364871da091e51f82ffbda828f6412b4a1ec', 'Glenda', 'Orpha', 'Moen', 'trohan@hotmail.com', '', '5336062314541129', 'Arden Medhurst', '1980-12-16', '', '664.806.6515x928', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (91, 'schulist.francisca', '433d5609c9b7740ed344a61ec1399a5a9035bb1c', 'Tiana', 'Trevion', 'O\'Hara', 'maggio.margot@gmail.com', '', '6011793588628438', 'Frida Cronin', '1982-04-13', '1', '536.506.1934', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (92, 'lelia62', 'dc7a187968a76dd2979230e82814cf3596e54439', 'Annabel', 'Franco', 'Heller', 'louisa.altenwerth@denesik.com', '1', '5372171845089902', 'Vivienne Schultz', '2009-07-14', '', '136-480-8775', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (94, 'gaylord.sherman', '889818ade5594642bc1b65de026ff79b6b1e3f9a', 'Abigail', 'Kelli', 'Huels', 'maida66@hotmail.com', '1', '4539880267450853', 'Caleigh Borer', '2009-03-13', '', '(144)133-4649', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (95, 'asia.morar', 'db1c764299eccd2bffe3f4f1e0a36f02a7ed6ec8', 'Jerad', 'Wendy', 'Brakus', 'king.ray@armstrong.net', '1', '5436927044154260', 'John Keeling IV', '1994-07-15', '', '149.270.6200x45164', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (96, 'yhand', 'c98ac7f355e053607ef67b28aadc2029b6b397d7', 'Audrey', 'Libbie', 'Zieme', 'sienna.gutmann@yahoo.com', '', '6011832608154956', 'Hyman Stark', '1979-10-07', '', '1-598-183-9196x02185', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (97, 'yesenia70', '0ab57a55c72905eb650fa3c1154aef6bd7bff325', 'Lambert', 'Ned', 'Walsh', 'angus22@fritsch.com', '', '4929908649365', 'Johnson King', '2015-08-04', '', '713.078.5351x71695', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (98, 'smitham.julien', '56b1eb442757be5c8896ef7c50c469cd6b869ae4', 'Christophe', 'Erick', 'Reichert', 'esperanza22@hotmail.com', '', '4532440709793', 'Claire Koelpin', '2009-01-21', '1', '+17(9)5651289404', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (99, 'loyce.jerde', '73352ecdcd76b8a2c5ee7e8f6bb575baee70d5b5', 'Deonte', 'Sincere', 'Yundt', 'lora.morar@gmail.com', '', '349677276742830', 'Dr. Halie Lubowitz V', '2019-08-30', '1', '(311)076-5042x136', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (100, 'ivy34', 'e29609434029ad9db9ba81452ef808516c903779', 'Samson', 'Ophelia', 'Schamberger', 'narciso04@yahoo.com', '', '4915720841180442', 'Elsa Dicki', '1975-08-10', '', '1-147-419-7218x58632', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (101, 'tleffler', 'fd05f4c5e7e45a30095de67dfdb55f12c22b7bb7', 'Chelsey', 'Sedrick', 'Tillman', 'laila73@glovernader.net', '', '5472869990841685', 'Jesse Lubowitz', '2014-05-01', '', '04183630152', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (102, 'aufderhar.dolly', '1b72dc7b7e3cb5b0f93f218cf7bdca6964c2785e', 'Easter', 'Roscoe', 'Nitzsche', 'runolfsson.mikel@hotmail.com', '1', '6011677913306791', 'Era Schuppe', '2012-04-27', '', '042.034.5436x9544', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (110, 'dcrooks', 'a784c3db2fee06faebdf9b2b9171a9ce50e5b67f', 'Amanda', 'Helen', 'Adams', 'jazmyn58@gmail.com', '1', '4002793455105296', 'Prof. Zackary Reichert', '1971-07-24', '', '(428)935-8226x3202', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (111, 'rosemarie67', '4d09abe9bb3b61949457f7329c5ce5486f74eaf4', 'Enid', 'Shaun', 'Kshlerin', 'dietrich.lillie@gmail.com', '1', '4929505412021', 'Mable Hane', '1987-10-26', '', '+93(0)2073656636', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (112, 'oernser', '1684eb5a7f54475dda00c5fe64350acaf22245d8', 'Lawson', 'Mariela', 'Bechtelar', 'cartwright.sarina@gmail.com', '', '4430644741943429', 'Laury Murray', '1971-03-14', '1', '136-446-0713x111', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (113, 'tgraham', 'e07db78fd774b321e44e8e874f9a3d8a034c41a4', 'Brennan', 'Angel', 'Jast', 'mollie70@haley.info', '', '5318175387975231', 'Prof. Nya Wolf', '1999-10-31', '', '1-060-129-5928x2225', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (114, 'kraig.lehner', 'ebc6927a217a6471e5c7df0d082f124ef82e4436', 'Bulah', 'Phoebe', 'Bashirian', 'cquitzon@toystrosin.com', '', '4929082431432', 'Thaddeus Leffler', '2017-08-31', '1', '647-936-6080x82337', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (115, 'therese.hamill', '1576f2f210aaa2786ccd3710a4cb8634dcca2b32', 'Titus', 'Miracle', 'Corkery', 'leanne.o\'connell@hotmail.com', '', '4401843674112951', 'Frederik Bailey', '2015-06-11', '1', '534.281.5839', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (116, 'xgorczany', 'a7ca7606a9754d6684d4bc0c0db0575f971c13ac', 'Ashly', 'Kaylah', 'Lehner', 'stanton.enrico@yahoo.com', '1', '343984373857640', 'Enoch Schowalter', '1980-10-12', '', '(259)006-8796', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (117, 'qdicki', 'd9c8aea726e8afd96210f174ceffc474a3932457', 'Dana', 'Thaddeus', 'Rodriguez', 'jamal.bradtke@fadel.biz', '', '5428498194677038', 'Benton Sporer', '2018-08-30', '', '1-816-642-3129x257', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (118, 'otto78', 'df9439878f5fb6ff9aff193a0504c61bc36eebed', 'Rylan', 'Wallace', 'Paucek', 'jovanny.stanton@greenfelder.org', '1', '6011602935891215', 'Prof. Pattie Heller MD', '2019-09-24', '', '(748)461-9127', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (119, 'o\'connell.celestino', 'fcb5bc4b96a2c6e0f7f2ba052e69f0c1d56dcdc7', 'Jeanne', 'Roscoe', 'O\'Conner', 'brooke84@gutmanndurgan.com', '', '5123209592631706', 'Nicolas McLaughlin', '1987-09-07', '1', '+81(7)0448014078', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (120, 'unique.aufderhar', '31c1b5b763092a0e989772c8f2cb507838defd81', 'Russel', 'Betty', 'Medhurst', 'awelch@balistreri.com', '1', '6011673300952440', 'Tessie Kilback', '1990-06-29', '', '(681)759-6588x8413', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (121, 'jazmyne87', 'eaf6ea370b242572a3c88691b5914deee53693d3', 'Fanny', 'Millie', 'Spencer', 'alfred.gleichner@gmail.com', '', '4580790333383', 'Chanel Wilkinson I', '1971-05-02', '1', '742-965-9746x7340', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (122, 'alexane.ferry', 'fc0742433a6472df45cfb62d0b8081adcb9f64fc', 'Patsy', 'Zaria', 'Corkery', 'schoen.alda@bergehand.info', '1', '4716425096923', 'Mr. Daryl Schneider V', '1983-07-03', '', '(253)922-2525', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (123, 'wyman.reinger', '35d36c23d8e5233c30b68334370cbce2427188c4', 'Cortney', 'Hilma', 'Kohler', 'randal05@hotmail.com', '', '4556393353062', 'Eleanora Botsford II', '2020-04-25', '', '705.311.1716x47625', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (124, 'zack17', '5bac2e7ad4208d2c7e3978ff63bd02f84f806e9c', 'Raphaelle', 'Sebastian', 'Marquardt', 'graciela91@carroll.biz', '1', '5328132549996444', 'Janelle Will', '1991-03-15', '', '345.632.6132', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (125, 'vbergstrom', 'df9342b6162269dbe770fd8f4b8bbbe18a4c1fb5', 'Ludie', 'Jonathon', 'Carroll', 'gutmann.elsa@yahoo.com', '', '5186037926337354', 'Miss Gisselle Raynor', '1999-08-23', '1', '1-506-337-0983x0247', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (126, 'reina32', '6e32f09cc1d34c3ab7a0c3a66f93134f416d83ff', 'Earnest', 'Erika', 'O\'Conner', 'arnoldo.witting@hackett.com', '1', '6011261120569198', 'Myrtle Rice', '1999-04-29', '1', '1-055-547-1341', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (127, 'omills', '0ca5a5a1d6a100fcd1ac84a63b5bda3c2e75f761', 'Dessie', 'Emie', 'Harvey', 'ifadel@yahoo.com', '1', '5431503102070795', 'Roel Kulas', '1993-03-15', '', '(742)437-0395x1162', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (128, 'agusikowski', '8f69f381ec2da0b5652a180be18878b7764d6c35', 'Sasha', 'Garrison', 'Roob', 'adaline28@kshlerin.net', '', '4556251700590725', 'Kaylah Abshire', '1987-10-11', '', '(501)416-9908', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (129, 'kuhlman.jett', '349c5604971a39ec75dd8f6b0e6ba9eb8bc236ed', 'Mariane', 'Nayeli', 'Muller', 'lkris@lueilwitz.com', '', '5444152505003326', 'Janet Kunze', '1988-01-18', '1', '851.981.0783x97693', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (130, 'medhurst.franz', '0fb000147780bc719da280dd87f6ba32ad3d19a6', 'Emie', 'Ellie', 'O\'Reilly', 'lwhite@legros.com', '', '4539534627453', 'Dr. Camren Greenholt', '2007-05-27', '1', '1-664-257-8036', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (131, 'kaylah87', 'd73dfe58f03c05f8fe2ae07101908bf821887c16', 'Miracle', 'Rubye', 'Mosciski', 'morris.braun@becker.com', '', '5163267897360837', 'Elyssa Bosco', '2003-06-18', '', '(266)575-3552', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (132, 'turner.hilton', 'c38a083a0ff296eb9bc864ba1a73d4b8dee374c9', 'Garrison', 'Dashawn', 'Kilback', 'camilla20@gmail.com', '', '4929774386545465', 'Prof. Alessandra Pfeffer', '1987-07-30', '', '05276197759', 'destini.beier');
...
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (136, 'xcasper', '4636b6b28f07308df8c143e9de8baf61e7c618a0', 'Moses', 'Loren', 'Klein', 'alford.breitenberg@gleichner.org', '1', '4929315111730740', 'Ms. Frida Thompson', '2008-11-22', '', '1-498-777-1730', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (137, 'stamm.rosemary', 'e5e7d8426c41cce2c95bddd7bcc2ded1988cc59c', 'Maddison', 'Eulah', 'Schaden', 'nmiller@hotmail.com', '1', '5422542079326909', 'Roberto Maggio', '1992-09-28', '', '585.328.7934x99381', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (138, 'olson.ines', '3a9b08c01ba01eb7e9d0b943679e4d2814eb44a6', 'Misty', 'Concepcion', 'Crona', 'ernestine.beatty@emard.com', '1', '4539340765504235', 'Rhea Grant IV', '1983-08-18', '', '855-535-7817x265', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (139, 'laura82', '9b65bbd77a1e40019bedfda1fa2cf499e7b997ee', 'Imogene', 'Angelina', 'Daniel', 'margarette66@yahoo.com', '1', '347453943975282', 'Miss Anabelle Waters Sr.', '1970-05-19', '', '131.567.8356', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (140, 'vita.larson', '4c897c5feb10b9d22e165fba9ac10f95f71fc8f4', 'Kallie', 'Kirstin', 'Koepp', 'qwaelchi@torphy.org', '', '5558774720103030', 'Katarina Terry', '1976-04-24', '', '(037)983-4225x8903', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (141, 'elisabeth.hauck', 'fc10c72083627695e9b699bd62cf2944bf2a3998', 'Domenica', 'Orville', 'Mitchell', 'kilback.yasmeen@reilly.net', '', '6011308104289621', 'Craig Kuhic', '1998-03-14', '', '995.674.2112x0334', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (142, 'melba.prohaska', 'afc866bad8d3376e2f7b59988460d54af41921b0', 'Kattie', 'Charity', 'Brown', 'helena.miller@yahoo.com', '1', '5545118359706956', 'Pierre Becker Sr.', '1972-01-21', '', '+58(6)3952459637', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (143, 'fhoppe', '8fa5534bb4424d40a283838b149550d225a954b8', 'Dewitt', 'Hilton', 'Boehm', 'stevie32@heaney.com', '1', '340194309776255', 'Colleen Gislason Sr.', '2004-11-17', '', '1-572-919-8989x413', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (144, 'annie.trantow', '510ecb2e82e9cb38ab4a214e9d77b4ad17419a25', 'Novella', 'Erick', 'Tillman', 'cwill@dubuquepredovic.info', '', '5125002356817283', 'Prof. King Wolff MD', '1978-01-23', '', '1-785-260-9521x3471', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (145, 'rita77', '52723496f5329dc5dcb454db8a7f101ca5952499', 'Kristin', 'Shyann', 'Wyman', 'carroll.rafaela@powlowskichamplin.com', '', '5139317280375111', 'Miss Christelle Krajcik', '2018-06-05', '1', '235.934.5454', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (146, 'eddie.kris', '76ce8337f8a49d5bafdd787e1c5bc38adac3f34d', 'Lucas', 'Wilhelmine', 'Hickle', 'bpurdy@littletremblay.com', '', '379844234457465', 'Mr. Eleazar Zemlak', '2020-04-19', '', '05156988940', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (147, 'roob.michelle', '809129840941db5fa55990016a23ff4d2b8c7fb2', 'Solon', 'Chelsie', 'Legros', 'xhermiston@hotmail.com', '', '4929098573424302', 'Immanuel Daniel', '2013-10-22', '', '+46(0)9317740187', 'destini.beier');
INSERT INTO `Person` (`User_ID`, `Username`, `Pass_word`, `First_Name`, `Middle_Name`, `Last_Name`, `Email_ID`, `Is_Card_Saved`, `Card_no`, `Name_on_Card`, `Expire_Date`, `Is_UPI_Saved`, `UPI_ID`, `Admin_Username`) VALUES (148, 'jgraham', '6c04a4efd36de09d73e6f116d52ec5f552fcdc9b', 'Watson', 'Kade', 'Howell', 'zschneider@yahoo.com', '', '4916317197845', 'Holly Cremin', '1989-03-06', '1', '716.630.1553', 'destini.beier');
...
CREATE TABLE `Person_Phone` (
  ...
  KEY `User_ID` (`User_ID`),
  CONSTRAINT `Person_Phone_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `Person` (`User_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Product_Category` (
  ...
  KEY `Admin_Username` (`Admin_Username`),
  CONSTRAINT `Product_Category_ibfk_1` FOREIGN KEY (`Admin_Username`) REFERENCES `Adminn` (`Username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Product_Sales` (
  ...
  KEY `Product_ID` (`Product_ID`),
  KEY `Customer_ID` (`Customer_ID`),
  CONSTRAINT `Product_Sales_ibfk_1` FOREIGN KEY (`Product_ID`) REFERENCES `Product` (`Product_ID`),
  CONSTRAINT `Product_Sales_ibfk_2` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Rates_Delivery`;
...
CREATE TABLE `Rates_Delivery` (
  ...
  KEY `Customer_ID` (`Customer_ID`),
  KEY `Delivery_ID` (`Delivery_ID`),
  CONSTRAINT `Rates_Delivery_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`),
  CONSTRAINT `Rates_Delivery_ibfk_2` FOREIGN KEY (`Delivery_ID`) REFERENCES `Delivery_Person` (`DelPerson_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `Rates_Product`;
...
CREATE TABLE `Rates_Product` (
  ...
  KEY `Customer_ID` (`Customer_ID`),
  KEY `Product_ID` (`Product_ID`),
  CONSTRAINT `Rates_Product_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `Customer` (`Customer_ID`),
  CONSTRAINT `Rates_Product_ibfk_2` FOREIGN KEY (`Product_ID`) REFERENCES `Product` (`Product_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
